...
public class DtCollisionSimulation
{
    ...
    public void Tick()
    {
        ...
        Span<Vector2Fi> lastPositionCache = stackalloc Vector2Fi[colObjs.Length];
        ...
        for(int i1 = 0; i1 < colObjs.Length; ++i1)
        {
            ...
            if(currShape.StepAmount > 1)
            {
                if(currShape.IntersectOnly)
                {
                    ...
                    Vector2Fi unsegmentedMov = currShape.Position - currShape.LastPosition;

                    Vector2Fi movSegment = unsegmentedMov / stepAmount;

                    Vector2Fi movSegModulus = unsegmentedMov - unsegmentedMov * stepAmount;
