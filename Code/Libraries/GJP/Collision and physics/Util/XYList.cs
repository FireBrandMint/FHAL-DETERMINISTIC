...
public class XYList<T> where T:XYBoolHolder
{
    ...
    public long[] AddNode(T value, Vector2Fi topLeft, Vector2Fi bottomRight)
    {
    ...
    ///Gets x1,x2,y1,y2;
    ///</summary>
    public long[] GetRanges(Vector2Fi topLeft, Vector2Fi bottomRight)
    {
        long[] XYR = new long[4]
        {
            (long)topLeft.x,
    ...
    public long[] GetRanges(Vector2Fi topLeft, Vector2Fi bottomRight, long[] ranges)
    {
    ...
    public bool RangesDiffer (long[] currRanges, Vector2Fi nextTopLeft, Vector2Fi nextBottomRight)
    {
